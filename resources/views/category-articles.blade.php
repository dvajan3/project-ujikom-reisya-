...
@section('title', $category->nama_kategori . ' - Articles')

@section('content')
<!-- Category Articles Area Start -->
                ...
                <div class="blog_left_sidebar">
                    ...
                    @else
                        <div class="text-center">
                            ...
                            <a href="{{ route('categori') }}" class="btn btn-primary">Back to Categories</a>
                        </div>
                    @endif
                </div>
            </div>
